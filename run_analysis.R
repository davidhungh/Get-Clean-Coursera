...
# Make descriptive variables of measurement
mean_features <- read.table("./mean_features.txt")
mean_features_names <- mean_features[,2]
names(tidyData) <- mean_features_names
